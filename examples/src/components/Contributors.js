	...
	render () {
		return (
			<div className="section">
				<h3 className="section-heading">{this.props.label}  <a href="https://github.com/martin8877/react-select-pre/blob/master/examples/src/components/Contributors.js">(Source)</a></h3>
